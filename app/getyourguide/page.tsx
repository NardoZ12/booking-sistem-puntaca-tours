...
export default function GYGPage({ bookings = [], onAdd = () => {}, onUpdate = () => {}, onDelete = () => {} }: Props) {
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-white tracking-wider">GET YOUR GUIDE</h1>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm rounded-lg font-medium tracking-wider cursor-pointer hover:opacity-90 transition-opacity"
          style={{ background: "#FF5533", color: "#fff", border: "none" }}
        >
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-neutral-900 border border-neutral-700 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold font-mono" style={{ color: "#FF5533" }}>
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-16 text-neutral-500">
          ...
          <p className="font-medium text-white mb-1">Sin reservas de GetYourGuide</p>
